<script lang="ts">
	...
	$: themeClasses = outlined
		? "border-primary text-primary hover:(text-primary-60 border-primary-60 bg-primary-20) focus-visible:(text-primary-60 border-primary-60 bg-primary-20) dark:hover:(text-white border-white bg-dark-700)"
		: "border-primary bg-primary text-white hover:(bg-primary-60 border-primary-60) focus-visible:(bg-primary-60 border-primary-60)";
